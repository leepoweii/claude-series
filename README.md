...
```
00-terms/             Ep 0：名詞解釋與課程大綱
01-Chat/              Series 1：Claude Chat
  Artifacts/            資料分析用 CSV 素材
02-Cowork/            Series 2：Claude CoWork
  Attachments/          半畝咖啡品牌素材、對帳單、供應商資料
    emails/             廠商對帳單 PDF
    半畝咖啡/           品牌 Context 素材
```
